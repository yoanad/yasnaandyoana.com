...
const App = () => {
  ...
  return (
    <div className="App">
      ...
      <main ref={formRef}>
        <div className='form'>
          <iframe title="interest form" src="https://docs.google.com/forms/d/e/1FAIpQLSf0vfAcnC_gdUixpfbpFYbFTKDVYmgQoYOTHSc8f4WAeo9aSA/viewform?embedded=true" width="100%" height="100%" frameborder="0" marginheight="0" marginwidth="0" scrolling="yes">Loading…</iframe>
        </div>
